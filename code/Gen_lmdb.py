...
df_train = [img for img in glob.glob("/home/ubuntu/DeepLearning_crop_classification/input/train/*jpg")]
df_test = [img for img in glob.glob("/home/ubuntu/DeepLearning_crop_classification/input/test/*jpg")]
